...
class App {
  ...
  private routes(): void {
    ...
    router.get('/stats', (req, res, next) => {
      ...
      //Il faut passer un nouveau tableau de joueurs, mais les objets doivent contenir une propriété ratio qui est le nombre de succès divisé par le nombre de tentatives.
